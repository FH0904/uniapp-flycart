...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"购物车动画","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 4 */
/*!*********************************************************************!*\
  !*** C:/Users/Administrator/Desktop/demo/uniapp-flycart/pages.json ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 17 */
/*!***************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/demo/uniapp-flycart/utils/flyCart.js ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; /**
                                                                                                      ...
                                                                                                      */
function flycart(startPoint, endPoint, point) {var h = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;var hclientX = arguments.length > 4 ? arguments[4] : undefined;
  /* 
  ...
  var yA = 0;
  /* x轴偏移量 */
  var offsetX = startPoint[0];
  /* y轴偏移量 */
  var offsetY = startPoint[1];
  /* B点横坐标 */
  var xB = endPoint[0] - offsetX;
  /* B纵坐标 */
  var yB = endPoint[1] - offsetY;
  ...
  function handerComputer() {
    if (h < 10) {
      ...
      /* 有效达到最高点时候的x坐标 */
      var effectMaHx = hclientX && Math.abs(hclientX - offsetX) > 0 && Math.abs(hclientX - offsetX) < Math.abs(xB);
      /* 如果hclientX不满足要求，则选A , B 中点为   */
      var maxHx = effectMaHx ? hclientX - offsetX : (xB + xA) / 2;
  ...
  var travelList = [];
  /* x 均等分 */
  var averageX = (xB - xA) / point;

  /* 处理直线运动 */
  function handerLinearMotion(type) {
    if (type === 'X') {
      var averageY = (yB - yA) / point;
      for (var i = 1; i <= point; i++) {
        travelList.push([offsetX, i * averageY + offsetY]);
      }
    } else {
      for (var _i = 1; _i <= point; _i++) {
        travelList.push([offsetX + _i * averageX, offsetY]);
      }
    }
    return travelList;
  }
  ...
  /* 绘制路径 */
  for (var i = 1; i <= point; i++) {
    var currentX = averageX * i;
    var currentY = Math.pow(currentX, 2) * a + b * currentX - yA;
...
flycart;exports.default = _default;
